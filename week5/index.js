...
//get request
axios.get("https://api.vschool.io/[jessica.gray]/todo")
.then(response => {
    ...
    checkbox.addEventListener("click", (event) => {
        ...
        axios.put("https://api.vschool.io/[jessica.gray]/todo/" + event.currentTarget.id, {completed:updates})
    ...
    const button = document.createElement("button")
        ...
        axios.delete("https://api.vschool.io/[jessica.gray]/todo/" + event.currentTarget.id)
...
form.addEventListener("submit", function(event){
    ...
    axios.post("https://api.vschool.io/[jessica.gray]/todo", newTodo)
        .then(response => {response.data 
        form.reset()})
        .catch(error => console.log(error))
